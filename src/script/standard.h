 ...
 */
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, std::vector<std::vector<unsigned char> >& vSolutionsRet, std::vector<std::vector<unsigned char> >* pvTxRuleScriptsRet = NULL);
